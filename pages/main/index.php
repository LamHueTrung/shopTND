...
<div style="clear:both;"></div>
				...
				?>
				<p style="margin-left: 20px;">Trang hiện tại : <?php echo $page ?>/<?php echo $trang ?> </p>
				...
				<ul class="list_trang">
					...
					for($i=1;$i<=$trang;$i++){ 
					?>
						<li  <?php if($i==$page){echo 'style="background: brown;margin-left: 20px;"';}else{ echo ''; }  ?>><a href="index.php?trang=<?php echo $i ?>"><?php echo $i ?></a></li>
					<?php
					} 
					?>
